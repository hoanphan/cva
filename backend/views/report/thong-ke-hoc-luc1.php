...
<div style="text-transform: uppercase; text-align: center">
    <b style="text-transform: uppercase">Chất lượng học lực học sinh <?=DSHocKy::getNameSemester($idSemester).'     - NĂM HỌC '.DSNamHoc::getNameCurrentYear()?></b>
</div>
<table style="width: 100%; border-spacing: 0px"; border="1">
    <thead >
        <tr style="background: #bababa; text-align: center">
            ...
            <th colspan="<?=count($dsHocLuc)*2?>" style="text-align: center">HỌC LỰC</th>
    ...
    <tbody>
        <tr style="height: 30px">
            ...
            <?php for($i=0;$i<count($dsHocLuc);$i++):?>
                <td  style="text-align: center"><?php $sl=HanhKiemHocLucBLL::getSLHocLucHanhKiemAllLevel($idLevel,$idSemester,$dsHocLuc[$i]->MaHocLuc,1);
                echo  $sl;?></td>
